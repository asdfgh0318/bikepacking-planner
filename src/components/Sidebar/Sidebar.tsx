        ...
        <>
          <nav className="tab-nav">
            ...
            <button className={`tab ${activeTab === 'gear' ? 'active' : ''}`} onClick={() => setActiveTab('gear')}>
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><rect x="7" y="3" width="10" height="10" rx="2"/></svg>
              Gear
            </button>
